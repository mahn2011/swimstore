                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +2 55 66 789</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="search_box pull-right">
                        <input type="text" style="font-weight: bold;" name="keywords_submit" placeholder="Tìm Kiếm Sản Phẩm"/>
                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
                                <h1><span>SwimWear</span>-Store</h1>
